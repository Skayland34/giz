...
def pagina_principal():
    ...
    fig1.update_layout(width=800, height=500, margin=dict(l=40, r=40, b=40, t=80), title_x=0.5, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
    fig2 = px.pie(data, 
                 names="Estado del proceso", 
                 )
    fig2.update_layout(autosize=True, margin=dict(l=40, r=40, b=40, t=80), title_x=0.5, paper_bgcolor="rgba(0,0,0,0)")
    ...
    fig3.update_layout(autosize=True, margin=dict(l=40, r=40, b=40, t=80), title_x=0.5, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
    data.rename(columns={
    ...
    fig4.update_layout(autosize=True, margin=dict(l=40, r=40, b=40, t=80), title_x=0.5, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
    ...
    fig5 = px.bar(cruce_region_poblacion,
                  ...
                  labels={"Participantes": "N° de Participantes"},
                  template="plotly_white")
    fig5.update_layout(autosize=True, margin=dict(l=40, r=40, b=40, t=80), title_x=0.5, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)")
    ...
    fig6.update_layout(title_x=0.5, margin=dict(l=0, r=0, b=0, t=40))
    ...
    fig7.update_layout(title_x=0.5,  margin=dict(l=0, r=0, b=0, t=40))
    graphs = {
